...
const About = (props) => {
  ...
  <div className="accordion-item">
    ...
    <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
      <div className="accordion-body">
        This word Counter software words in any web browser such as chrome ,firefox,internet explorer,safari . it suits to count Character in facebook ,blog, books , excel essays, etc.
      </div>
    </div>
  </div>
</div>
